  ...
  <div style='border: 1px solid var(--q-accent); border-radius: .5rem;'>
    ...
    >
      ...
      <q-card-section>
        ...
        <p>
        lunar is a client for Nostr. while lunar is implementing a social media usecase of Nostr, the possibilities of Nostr are endless.
      ...
      <q-card-section>
        ...
        <p>
          ...
          <ul>
            ...
            key - which is why you only need to enter your private key for lunar to
        ...
        <p>
          ...
          uses is preferable over the hex format that lunar uses because there is a visual
          indicator preventing the user from mixing up their public and private key. lunar
    ...
    >
      ...
      <q-card-section>
        <p>
          ...
          while I can promise you that lunar does not store your private key (it is stored locally in your
          browser and is NEVER sent to back to lunar) and that I am doing my best to prevent vulnerabilities,
    ...
    >
      ...
      <q-card-section>
        ...
        <ol>
          ...
          lunar doesn't refresh automatically please refresh the page</li>
          <li>proceed to <strong>how to use lunar?</strong> section below</li>
        </ol>
      </q-card-section>
    </q-expansion-item>
    <div style='max-height: 0; border-top: 1px solid var(--q-accent)'/>
      ...
      <q-card-section>
        <p>
          ...
          <ul>
            ...
            <li>if you are on a mobile device the easiest option will be using lunar</li>
        ...
        <div style='border: 1px solid var(--q-accent); border-radius: .5rem;'>
          ...
          >
            <template #header>
              <span class='full-width text-bold'>use lunar</span>
            </template>
            <q-card-section>
              <ol>
          ...
          >
            ...
            <q-card-section>
              <ol>
                ...
                <li>refresh lunar.ninja page and hit the <strong>USE PUBLIC KEY FROM EXTENSION</strong> option that should appear in the key input</li>
                <li>proceed to <strong>how to use lunar?</strong> section below</li>
              </ol>
            </q-card-section>
          </q-expansion-item>
    ...
    >
      <template #header>
        <span class='full-width text-bold'>how to use lunar?</span>
      </template>
      <q-card-section>
        <ol>
          <li>
          ...
          <li>
            ...
            relays, make sure to include a relay you typically use or lunar may not be able to find your user.
            the bootstrap relays are NOT used as your user's relay list, lunar only uses these to find your
            user's information and settings when loading your Nostr account.
          </li>
          <li>
            <strong>hit PROCEED</strong> lunar will login and attempt to find your user information. please
          ...
          <li>
            ...
            lunar customer service to reset your password.
          </li>
          <li>
            ...
            <ul>
              ...
              Nostr relays (if you have never set your relays on Nostr, lunar will use lunar's default relay
              ...
              <li><strong>preferences</strong> saving this section will update the look of lunar for this browser.
